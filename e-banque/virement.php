<?
		// effectuer des virement interne
...
<table width="825" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="22" colspan="14" valign="top"><div align="center"><strong><font color="#000099" size="+1" face="Verdana, Arial, Helvetica, sans-serif">Virements 
        entre vos comptes</font></strong></div></td>
    <td width="13"></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td colspan="9" valign="top"><font color="#CC0000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Pour 
      faire un virement entre vos comptes, vous n'avez qu'&agrave; selectionner 
      le compte &agrave; d&eacute;biter, puis celui &agrave; cr&eacute;diter dans 
      les menus deroulant. </strong></font></td>
    <td></td>
    <td></td>
    <td></td>
  </tr>
  ...
  <form name="saisie" action="effvire.php" method="get">
    <tr> 
      <td height="24"></td>
    ...
    <tr> 
      ...
      <td>&nbsp;</td>
      <td colspan="5" valign="top"><select name="credit">
          <option value="" selected>Compte à créditer</option>
          <option value="">----------------------------------------</option>
          <?
		$sql = "SELECT * FROM $table,$compte WHERE ident = '$auth' and passwd = '$passwd' and $compte.ID_client=$table.ID_client";
			// execute requette SQL et renvoie un index
